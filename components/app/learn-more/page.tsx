...
import { ExternalLink, ArrowLeft, ArrowRight, FileText } from "lucide-react"
...
export default function LearnMorePage() {
  ...
  const goToJoinUs = () => {
    // Navigate to join-us page with scroll to top
    router.push("/join-us")
      ...
      <div className="max-w-3xl w-full space-y-6 mb-16">
        ...
        <div className="space-y-4 mt-6">
          ...
          <Button
            ...
            className="bg-[#5D9D61] hover:bg-[#4c8050] text-white w-full py-6 text-lg relative font-bold"
          >
