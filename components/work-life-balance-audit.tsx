...
import { Heart, Home, Briefcase, ArrowRight, ArrowLeft, RefreshCw, Check, Sparkles, Brain, Leaf, Utensils, BookOpen, DollarSign, Users, Palette, HeartHandshake, Moon, User, Copy, ExternalLink, Info, Flower } from 'lucide-react'
...
`
    ...
    if (isExcellentScore) {
      prompt += `I'm doing well with my work-lifestyle balance, scoring ${overallScore}% overall!
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]">
        ...
        {!isResultsPage && (
          <DialogHeader>
            ...
            <DialogTitle className="text-xl">Work-Lifestyle Balance Audit</DialogTitle>
            <DialogDescription>
              Based on the 13 Core Life Value Areas from the Make Time For More™ Work-Lifestyle Balance Experience
            </DialogDescription>
          </DialogHeader>
        )}
        ...
        {isResultsPage && !showBetaInvite && (
          <DialogHeader>
            ...
            <DialogTitle className="text-xl text-center">Your Work-Lifestyle Balance Results Are In</DialogTitle>
          </DialogHeader>
        )}
          ...
          <div className="space-y-6">
            ...
            <Card className="border-[#E26C73] bg-[#f5f0e6]">
              <CardHeader className="pb-2">
                ...
                <CardDescription>
                  {isExcellentScore
                    ? "This FREE audit, created by Thought Leader Barbara is her gift to you that keeps on GIV*EN. Cherry Blossom can help you maintain your excellent work-lifestyle balance and continue your success journey."
                    : "This FREE audit, created by Thought Leader Barbara is her gift to you that keeps on GIV*EN -- as you can retake it anytime to access your work-lifestyle balance and holistic success. It's also the 1st Step to working with her. Enjoy the journey!"}
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="bg-white p-3 rounded-md border border-rose-100">
                  ...
                  <ol className="list-decimal pl-5 space-y-2 text-sm">
                    ...
                    <li>Click the "Chat with Cherry Blossom" button to open ChatGPT</li>
