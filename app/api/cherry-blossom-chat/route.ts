  ...
  try {
    ...
    if (!openai || !process.env.OPENAI_API_KEY) {
      ...
      return NextResponse.json(
        {
          error:
            "The AI chat feature is currently unavailable. Please contact your administrator to configure the OpenAI API key.",
          message: "I'm sorry, but the Cherry Blossom AI assistant is not yet configured. Please check back soon! 🌸",
        },
        { status: 503 },
      )
    }
