              ...
              <div className="py-6 px-8 flex flex-col justify-center bg-white">
                ...
                <div className="space-y-4 max-w-xl mx-auto">
                  ...
                  <div className="space-y-3">
                    <div className="text-center">
                      <p className="text-lg text-gray-800 mb-3">
                        <span className="font-semibold">Option 1:</span> Monday & Tuesday | 7:00–8:30 PM ET
                      </p>
                    </div>
                    <a
                      ...
                      className="block"
                    >
                      <Button className="w-full bg-[#7FB069]/60 hover:bg-[#7FB069] text-white rounded-lg text-base font-bold py-3">
                        Enter Onboarding Option 1
                      </Button>
                    </a>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="text-center">
                      <p className="text-lg text-gray-800 mb-3">
                        <span className="font-semibold">Option 2:</span> Wednesday & Thursday | 7:00–8:30 PM ET
                      </p>
                    </div>
                    <a
                      ...
                      className="block"
                    >
                      <Button className="w-full bg-[#E26C73]/60 hover:bg-[#E26C73] text-white rounded-lg text-base font-bold py-3">
                        Enter Onboarding Option 2
                      </Button>
                    </a>
                  </div>
                </div>
                ...
                {/* Footer Note */}
                <p className="text-xs text-gray-600 italic text-center mt-6">
